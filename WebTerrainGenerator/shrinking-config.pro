-injars target/WebTerrainGenerator-1.0-jar-with-dependencies.jar
-outjars target/WebTerrainGenerator-1.0-jar-with-dependencies-optimized.jar
...
-keep class wanderroutejs.Main

# Keep - Applications. Keep all application classes, along with their 'main'
# methods.
-keepclasseswithmembers public class wanderroutejs.Main {
