...
THREE.TrackballControls = function ( object, domElement ) {
	...
	this.getMouseProjectionOnBall = function ( clientX, clientY ) {
		...
		if ( length > 1.0 ) {
			...
			mouseOnBall.x = Math.sqrt( 1.0 - length * length );
		...
		projection.addSelf( _this.object.up.clone().crossSelf( _eye ).setLength( mouseOnBall.z ) );
		projection.addSelf( _eye.setLength( mouseOnBall.x ) );
