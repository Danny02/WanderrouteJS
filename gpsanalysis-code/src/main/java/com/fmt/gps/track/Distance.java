...
public class Distance {
	...
	public static double getFps(TrackPoint one, TrackPoint two) {
		...
		if(seconds == 0) return DEFAULT_FPS;
	...
	/**
	 * calculate haversine distance for linear distance between two lat/log coordinates.
	 ...
	 **/
	public static double getFeet(double lat1, double long1, double lat2, double long2) {
	 ...
	 * @return distance between them
	 **/
	private static double haversine_km2(double lat1, double long1, double lat2, double long2)
	{
